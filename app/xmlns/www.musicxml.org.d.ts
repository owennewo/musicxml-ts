...
// Source files:
// http://localhost:8000/spec/musicxml.xsd
...
interface _barline extends BaseType {
	...
	coda?: emptyPrintstylealign;
	ending?: ending;
	fermata?: fermata[];
	footnote?: formattedText;
	level?: level;
	repeat?: repeat;
	segno?: emptyPrintstylealign;
	wavyLine?: wavyLine;
}
...
export type beaterValue = ("bow" | "chime hammer" | "coin" | "finger" | "fingernail" | "fist" | "guiro scraper" | "hammer" | "hand" | "jazz stick" | "knitting needle" | "metal hammer" | "snare stick" | "spoon mallet" | "triangle beater" | "triangle beater plain" | "wire brush");
...
export type breathMarkvalue = ("" | "comma" | "tick");
...
export type effect = ("anvil" | "auto horn" | "bird whistle" | "cannon" | "duck call" | "gun shot" | "klaxon horn" | "lions roar" | "police whistle" | "siren" | "slide whistle" | "thunder sheet" | "wind machine" | "wind whistle");
...
export type enclosureShape = ("rectangle" | "square" | "oval" | "circle" | "bracket" | "triangle" | "diamond" | "none");
...
export type fermataShape = ("normal" | "angled" | "square" | "");
...
interface _fontSize extends _string2 {}
...
export type glass = "wind chimes";
interface _glass extends Primitive._string { content: glass; }
...
export type handbellValue = ("damp" | "echo" | "gyro" | "hand martellato" | "mallet lift" | "mallet table" | "martellato" | "martellato lift" | "muted martellato" | "pluck lift" | "swing");
...
export type membrane = ("bass drum" | "bass drum on side" | "bongos" | "conga drum" | "goblet drum" | "military drum" | "snare drum" | "snare drum snares off" | "tambourine" | "tenor drum" | "timbales" | "tomtom");
...
export type metal = ("almglocken" | "bell" | "bell plate" | "brake drum" | "Chinese cymbal" | "cowbell" | "crash cymbals" | "crotale" | "cymbal tongs" | "domed gong" | "finger cymbals" | "flexatone" | "gong" | "hi-hat" | "high-hat cymbals" | "handbell" | "sistrum" | "sizzle cymbal" | "sleigh bells" | "suspended cymbal" | "tam tam" | "triangle" | "Vietnamese hat");
...
export type noteheadValue = ("slash" | "triangle" | "diamond" | "square" | "cross" | "x" | "circle-x" | "inverted triangle" | "arrow down" | "arrow up" | "slashed" | "back slashed" | "normal" | "cluster" | "circle dot" | "left triangle" | "rectangle" | "none" | "do" | "re" | "mi" | "fa" | "fa up" | "so" | "la" | "ti");
...
export type noteSizetype = ("cue" | "grace" | "large");
...
interface _numberOrnormal extends _string2 {}
...
export type pitched = ("chimes" | "glockenspiel" | "mallet" | "marimba" | "tubular chimes" | "vibraphone" | "xylophone");
interface _pitched extends Primitive._string { content: pitched; }
...
interface _positiveIntegerorempty extends _string2 {}
...
export interface ScorePartwiseType extends _ScorePartwiseType { constructor: { new(): ScorePartwiseType }; }
export var ScorePartwiseType: { new(): ScorePartwiseType};

interface _ScorePartwiseTypePartType extends BaseType {
	id: string;
	measure: ScorePartwiseTypePartTypeMeasureType[];
}
export interface ScorePartwiseTypePartType extends _ScorePartwiseTypePartType { constructor: { new(): ScorePartwiseTypePartType }; }
export var ScorePartwiseTypePartType: {new ():ScorePartwiseTypePartType};
...
export interface ScorePartwiseTypePartTypeMeasureType extends _ScorePartwiseTypePartTypeMeasureType { constructor: { new(): ScorePartwiseTypePartTypeMeasureType }; }
// OWENW: Manually exported this for convenience
export var measure: { new(): ScorePartwiseTypePartTypeMeasureType };
...
export type stickType = ("bass drum" | "double bass drum" | "timpani" | "xylophone" | "yarn");
...
interface _string2 extends _string2Number {
	color: string;
	defaultX: number;
	defaultY: number;
	fontFamily: string;
...
export interface string2 extends _string2 { constructor: { new(): string }; }
export var string2: { new(): string };

/** The string-mute type represents string mute on and mute off symbols. */
interface _string2Mute extends BaseType {
	color: string;
	defaultX: number;
	defaultY: number;
	fontFamily: string;
...
export interface stringMute extends _string2Mute { constructor: { new(): stringMute }; }
...
type _string2Number = Primitive._number;
...
export type symbolSize = ("full" | "cue" | "large");
...
interface _textFontcolor extends Primitive._string {
	color: string;
	dir: textDirection;
	fontFamily: string;
	fontSize: fontSize;
...
export interface textFontcolor extends _textFontcolor { constructor: { new(): textFontcolor }; }
export var textFontcolor: { new(): textFontcolor };
...
export type wood = ("board clapper" | "cabasa" | "castanets" | "claves" | "guiro" | "log drum" | "maraca" | "maracas" | "ratchet" | "sandpaper blocks" | "slit drum" | "temple block" | "vibraslap" | "wood block");
...
interface _yesNonumber extends _string2 {}
